...
private fun Project.releaseSigningSpec(): ReleaseSigningSpec {
    ...
    if (providedOverrideCount != 0 && providedOverrideCount != overrides.size) {
        val missingOverrides = overrides

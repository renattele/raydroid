...
val LocalRContextActionOverlayState =
    staticCompositionLocalOf {
        RContextActionOverlayState()
    }

fun Modifier.rContextActionAnchor(sourceId: String?): Modifier =
    composed {
        if (sourceId == null) {
...
fun Modifier.rContextActionInactiveLayer(blur: Boolean = true): Modifier =
    composed {
        val overlayState = LocalRContextActionOverlayState.current
...
fun Modifier.rContextActionInactiveItem(sourceId: String?): Modifier =
    composed {
        val overlayState = LocalRContextActionOverlayState.current
        val isInactive =

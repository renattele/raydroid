...
internal class NotificationServiceImpl(
    ...
    override suspend fun <T> showToast(
    ...
    private fun NotificationServiceBridge.AlertAction.toServiceAction() =
        NotificationService.AlertAction(
            title = title,
            style = style.toServiceStyle(),
        )

    private fun NotificationService.AlertAction.toBridgeAction() =
        NotificationServiceBridge.AlertAction(
            title = title,
            style = style.toBridgeStyle(),
        )

    private fun NotificationServiceBridge.AlertAction.Style.toServiceStyle() =
        when (this) {
    ...
    private fun NotificationService.AlertAction.Style.toBridgeStyle() =
        when (this) {
    ...
    private fun NotificationServiceBridge.Toast.toServiceToast() =
    ...
    private fun NotificationService.Toast.toBridgeToast() =
    ...
    private fun NotificationServiceBridge.Toast.Style.toServiceStyle() =
        when (this) {
    ...
    private fun NotificationService.Toast.Style.toBridgeStyle() =
        when (this) {

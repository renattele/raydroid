...
interface NotificationService {
    ...
    suspend fun <T> showToast(toast: Toast, block: suspend () -> T): T
    ...
    suspend fun showLoadingToast(message: UiText, autoDismissMillis: Long? = null) {
    ...
    suspend fun showLoadingToast(message: String, autoDismissMillis: Long? = null) {

...
fun List<Permission>.readable(): Boolean = contains(Permission.Read) || contains(Permission.Manage)

fun List<Permission>.writable(): Boolean = contains(Permission.Write) || contains(Permission.Manage)

...
internal class SystemServiceImpl(
    ...
    override suspend fun getApps(): List<SystemService.Application> = bridge.getApps().map { it.toServiceApp() }
    ...
    private fun SystemServiceBridge.RawApplication.toServiceApp() =
    ...
    private fun SystemService.Application.toBridgeApp() =
    ...
    private fun SystemServiceBridge.OpenOptions.toServiceOptions() =
        SystemService.OpenOptions(
            keys = keys,
        )

    private fun SystemService.OpenOptions.toBridgeOptions() =
        SystemServiceBridge.OpenOptions(
            keys = keys,
        )
}
